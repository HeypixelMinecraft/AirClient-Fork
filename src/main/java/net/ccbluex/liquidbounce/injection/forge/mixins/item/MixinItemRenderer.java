...
public abstract class MixinItemRenderer {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        float f1 = noSwing.handleEvents() && noSwing.getClientSide() ? 0f : RotationUtils.INSTANCE.getPlayerSwingProgress(abstractclientplayer, partialTicks);
        float f2 = RotationUtils.INSTANCE.getPlayerPrevPitch(abstractclientplayer) + (RotationUtils.INSTANCE.getPlayerPitch(abstractclientplayer) - RotationUtils.INSTANCE.getPlayerPrevPitch(abstractclientplayer)) * partialTicks;
        float f3 = RotationUtils.INSTANCE.getPlayerPrevYaw(abstractclientplayer) + (RotationUtils.INSTANCE.getPlayerYaw(abstractclientplayer) - RotationUtils.INSTANCE.getPlayerPrevYaw(abstractclientplayer)) * partialTicks;
        ...
        if (itemToRender != null) {
            ...
            } else if (((net.minecraft.entity.player.EntityPlayer) abstractclientplayer).getItemInUseCount() > 0 || isForceBlocking) {
        ...
        } else if (!((net.minecraft.entity.Entity) abstractclientplayer).isInvisible()) {
