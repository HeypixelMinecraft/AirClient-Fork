...
public abstract class MixinEntityRenderer {
    ...
    private void getMouseOver(float p_getMouseOver_1_, CallbackInfo ci) {
        ...
        if (entity != null && mc.theWorld != null) {
            ...
            Rotation rotation = RotationUtils.INSTANCE.getPlayerRotation(mc.thePlayer);
        ...
        if (this.lightmapUpdateNeeded) {
            ...
            if (world != null) {
                ...
                for (int i = 0; i < 256; ++i) {
                    ...
                    if (((EntityLivingBase) this.mc.thePlayer).isPotionActive(Potion.nightVision)) {
    ...
    private boolean injectAntiBlindA(EntityPlayerSP instance, Potion potion) {
        ...
        return (!module.handleEvents() || !module.getConfusionEffect()) && ((EntityLivingBase) instance).isPotionActive(potion);
    }
