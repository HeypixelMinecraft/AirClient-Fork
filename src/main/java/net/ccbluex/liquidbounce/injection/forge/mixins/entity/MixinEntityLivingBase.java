...
public abstract class MixinEntityLivingBase extends MixinEntity {
    ...
    private float hookBodyRotationsA(EntityLivingBase instance) {
        ...
        return instance instanceof EntityPlayerSP && Rotations.INSTANCE.shouldUseRealisticMode() && rotation != null ? rotation.getYaw() : RotationUtils.INSTANCE.getPlayerYaw(instance instanceof EntityPlayer ? (EntityPlayer) instance : null);
    }
    ...
    private void onDamageEntity(CallbackInfo ci) {
        EventManager.INSTANCE.call(new EntityDamageEvent((EntityLivingBase) (Object) this));
    }
}
