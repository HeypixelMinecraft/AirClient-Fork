...
object AntiKnockBack : Module("AntiKnockBack", Category.COMBAT) {
    ...
    private val tagMode by choices("TagMode", arrayOf("Default", "Custom"), "Default") { tagState }
    private val customText by text("CustomTagText", "") { tagState && tagMode == "Custom" }
    private val authorName by boolean("AuthorName", true) { tagState }
