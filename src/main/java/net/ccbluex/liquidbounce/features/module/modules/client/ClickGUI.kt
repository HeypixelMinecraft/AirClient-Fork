...
object ClickGUI : Module("ClickGUI", Category.CLIENT, Keyboard.KEY_RSHIFT, canBeEnabled = false) {
    private val style by choices(
        "Style",
        arrayOf("LiquidBounce", "Null", "Slowly", "Black", "Neon", "Minimal", "Glass", "Neverlose", "Augustus", "Opai"),
        "LiquidBounce"
    ).onChanged {
        updateStyle()
    }
    ...
    private val color by color("Color", Color(0, 160, 255)) { style !in arrayOf("Slowly", "Black", "Neverlose", "Augustus", "Opai") }
